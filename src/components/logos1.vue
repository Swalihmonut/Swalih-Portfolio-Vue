<template>
  <div class="logos1-container1 thq-section-padding">
    <div class="logos1-max-width thq-section-max-width">
      <h2 class="logos1-text1 thq-heading-2">
        <slot name="heading1">
          <!--Default content for heading1-->
          <div class="logos1-fragment">
            <span class="logos1-text2">
...
export default {
  ...
  props: {
    logo1Alt: {
      type: String,
      default: 'Business Analyst specializing in Life Sciences Manufacturing',
    },
    logo1Src: {
      type: String,
      default:
    ...
    logo6Alt: {
      type: String,
      default: 'Impactful Insights and Strategies',
    },
    logo4Src: {
      type: String,
      default:
