    ...
    <header data-thq="thq-navbar" class="navbar8-navbar-interactive">
      ...
      <div data-thq="thq-navbar-nav" class="navbar8-desktop-menu">
        <nav class="navbar8-links1">
          ...
          <div
            @click="link5DropdownVisible = !link5DropdownVisible"
        ...
        <div class="navbar8-buttons1">
          <button class="navbar8-action11 thq-button-filled thq-button-animated">
            <span>
              <slot name="action1">
                <!--Default content for action1-->
                <div><span>Main Action</span></div>
              </slot>
            </span>
          </button>
          <button class="navbar8-action21 thq-button-animated thq-button-outline">
            <span>
              <slot name="action2">
                <!--Default content for action2-->
                <div><span>Secondary Action</span></div>
              </slot>
            </span>
          </button>
        </div>
      ...
      <div data-thq="thq-mobile-menu" class="navbar8-mobile-menu">
            ...
            <a :href="link1Url" class="navbar8-link12 thq-body-small thq-link">
              <slot name="link1">
                ...
                <div class="navbar8-fragment20">
                  <span class="navbar8-text24">Home</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url" class="thq-body-small thq-link">
              <slot name="link2">
                ...
                <div class="navbar8-fragment14">
                  <span class="navbar8-text18">Portfolio</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link32 thq-body-small thq-link">
              <slot name="link3">
                <!--Default content for link3-->
                <div class="navbar8-fragment10">
                  <span class="navbar8-text14">Skills</span>
                </div>
              </slot>
            </a>
            <div class="navbar8-link4-accordion">
              <div
                @click="link5AccordionOpen = !link5AccordionOpen"
              ...
              >
                <span class="thq-body-small thq-link">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment22">
                      <span class="navbar8-text26">About</span>
                    </div>
                  </slot>
                </span>
                <div class="navbar8-icon-container2">
                  ...
                  <div v-if="!link5AccordionOpen" class="navbar8-container5">
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span class="thq-body-small">
                        <slot name="page1Description">
                          ...
                          <div>
                            <span>Summary of expertise and experience</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content2">
                      ...
                      <span class="thq-body-small">
                        <slot name="page2Description">
                          ...
                          <div>
                            <span>
                              Detailed projects showcasing business impact using
                              the STAR method
                            </span>
                          </div>
                        </slot>
                    ...
                    <div class="navbar8-content4">
                      ...
                      <span class="thq-body-small">
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>Background, experience, and values</span>
                          </div>
                        </slot>
                      </span>
                    </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment23">
                    <span class="navbar8-text27">Main Action</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment17">
                    <span class="navbar8-text21">Secondary Action</span>
                  </div>
                </slot>
              </span>
            </button>
        ...
        <div class="navbar8-icon-group">
          <svg viewBox="0 0 950.8571428571428 1024" class="thq-icon-x-small">
            ...
            ></path></svg
          ><svg viewBox="0 0 877.7142857142857 1024" class="thq-icon-x-small">
            <path
            ...
            ></path></svg
          ><svg viewBox="0 0 602.2582857142856 1024" class="thq-icon-small">
            <path
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment18">
                      <span class="navbar8-text22">Projects</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment12">
                      <span class="navbar8-text16">
                        Detailed projects showcasing business impact using the
                        STAR method
                      </span>
                    </div>
                  </slot>
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19">Skills</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text20">About</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
...
export default {
  ...
  props: {
    ...
    logoAlt: {
      type: String,
      default: 'Business Analyst Portfolio Logo',
    },
    linkUrlPage2: {
      type: String,
      default: 'https://www.teleporthq.io',
