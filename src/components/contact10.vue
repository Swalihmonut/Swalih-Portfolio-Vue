          ...
          <h2 class="thq-heading-2">
            <slot name="heading1">
              ...
              <div class="contact10-fragment5">
                <span class="contact10-text20">Locations</span>
              </div>
            </slot>
          </h2>
          ...
          <h3 class="contact10-text12 thq-heading-3">
            <slot name="location1">
              ...
              <div class="contact10-fragment6">
                <span class="contact10-text21">Bucharest</span>
              </div>
            </slot>
          </h3>
          <p class="thq-body-large">
          ...
          <h3 class="contact10-text14 thq-heading-3">
            <slot name="location2">
              ...
              <div class="contact10-fragment1">
                <span class="contact10-text16">Cluj - Napoca</span>
              </div>
            </slot>
          </h3>
          <p class="thq-body-large">
